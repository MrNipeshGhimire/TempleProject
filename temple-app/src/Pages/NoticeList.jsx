...
const NoticeList = () => {
  return (
    ...
    <header className="mx-auto max-w-screen-xl pt-28 text-center">
      ...
      <h1 className="mt-2 text-3xl font-bold text-gray-900 sm:text-5xl">Current Notice </h1>
      <p className="mt-6 text-lg text-gray-700">You're doing marketing the wrong way</p>
      
      <img className="sm:h-[34rem] mt-10 w-full object-contain" src="https://www.nefscun.org.np/wp-content/uploads/2024/12/notice-081.9.9_page-0001-1.jpg" alt="Featured Image" />
    </header>
